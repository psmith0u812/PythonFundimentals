# All about numbers
# Numeric types are broken down into 4 distinct catagories: int, float, & complex
...
# The methods below will convert an integer to differint numeric system values
print(bin(22))
print(oct(22))
print(hex(22))
