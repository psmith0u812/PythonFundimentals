...
# tuple of colors
# *args takes a tuple in values, but not as a variable. You will
# generate an error if you push a tuple variable directly
...
# using the default argumentallows you to have more than one, with one
...
# Main function is what is alled when a python file is ran through
# the compiler. It will preform all ations in the file accept functions unless
