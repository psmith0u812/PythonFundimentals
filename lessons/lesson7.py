...
# while loop
# Executes a set of statments until its condition is false
def basic_while(arg):
    alpha = arg
    while alpha < 4:
        print(alpha)
...
# for loop
# Executes a set of statements as it interates a colletion or sequence
def basic_for(arg):
    for alpha in arg:
        print(alpha)
...
# else statement
# Also used in loops, this statemen can be used after the loop ends
def basic_else():
    thing1 = 0
    while thing1 < 4:
        print(thing1)
